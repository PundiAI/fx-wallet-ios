...
private func itemContainerView() -> UIView {
...
extension SendChatGiftViewController {
    class CryptoCell: WKTableViewCell.TitleCell {
        ...
        override class func height(model _: Any?) -> CGFloat { 44 }
    }
}
...
extension SendChatGiftViewController {
    class View: UIView {
        ...
        fileprivate lazy var contentView = UIView(COLOR.backgroud)

...
//                    make.top.equalTo(titleLabel.snp.bottom).offset(4.auto())
        ...
        lazy var pannel:FxRoundBorderView = {
            return FxRoundBorderView.standard()
        }()
        ...
        lazy var createControl: UIButton = {
            let v = UIButton(frame: .zero)
            return v
        }()
        
        lazy var importControl: UIButton = {
            let v = UIButton(frame: .zero)
            return v
        }()
        ...
        private func layoutUI() {
            addView(titleLabel,subtitleLabel, pannel)
            pannel.contentView.addView(createItemView,lineView,importItemView)

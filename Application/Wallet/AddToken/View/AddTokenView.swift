...
extension AddTokenViewController {
    class NoDataCell: FxTableViewCell {
        ...
        private lazy var subtitleLabel = UILabel(text: TR("TokenList.NoResultNotice"), font: XWallet.Font(ofSize: 14), textColor: HDA(0x080A32).withAlphaComponent(0.5))
        override class func height(model _: Any?) -> CGFloat { 88.auto() }
        override func layoutUI() {

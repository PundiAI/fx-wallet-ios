...
extension SwapViewController {
    class ApprovePanel: UIView {
        class ItemView: UIView {
            ...
            func set(title: String, enable: Bool, waiting _: Bool = false) {
        ...
        private func layoutUI() {
            addSubviews([line, approveButton, swapButton, messageButton])
    ...
    class RounterView: UIView, UICollectionViewDelegateFlowLayout {
        ...
        private func layoutUI() {
            ...
            itemsObserver.map { [weak self] (items) -> [(RouterModel, Bool)] in
                self?.mapRouterData(items: items) ?? []
        ...
        func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt _: Int) -> UIEdgeInsets {
            ...
            let mu = CGFloat(SwapViewController.RounterView.lineCount(itemsObserver.value))

...
class EditPermissionViewController: WKViewController {
    ...
    var chooseAmount = BehaviorRelay<String>(value: "0")
    var select = BehaviorRelay<EditState>(value: .unlimited)
    ...
    override func viewDidAppear(_: Bool) {
        select.accept(vm.editState.value)

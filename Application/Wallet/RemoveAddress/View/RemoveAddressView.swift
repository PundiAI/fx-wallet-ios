...
extension RemoveAddressViewController {
    class ContentCell: FxTableViewCell {
        ...
        private lazy var noticeLabel1: UILabel = {
            let v = UILabel(text: TR("DeleteAddress.Notice1"), font: XWallet.Font(ofSize: 20, weight: .medium))
        ...
        private lazy var noticeLabel2: UILabel = {
            let v = UILabel(text: TR("DeleteAddress.Notice2"), font: XWallet.Font(ofSize: 14), textColor: UIColor.white.withAlphaComponent(0.5))
            v.textAlignment = .center
            v.autoFont = true
            v.numberOfLines = 0
            return v

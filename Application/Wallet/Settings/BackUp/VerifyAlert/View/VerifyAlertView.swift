    ...
    class ContentCell: FxTableViewCell {
        ...
        override class func height(model: Any?) -> CGFloat {
            ...
            let font0 = UILabel().then {
                $0.font = XWallet.Font(ofSize: 20, weight: .bold)
...
extension VerifyAlertErrorViewController {
    ...
    class ContentCell: FxTableViewCell {
        ...
        override class func height(model: Any?) -> CGFloat {
            ...
            let noticeHeight2 = messageString0.height(ofWidth: width, attributes: [.font: font2])
            return (32 + 56).auto() + (16.auto() + noticeHeight1) + (8.auto() + noticeHeight2 + 8.auto())
        }

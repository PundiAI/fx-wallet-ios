    ...
    class StartVerifyCell: SingleCell {
        ...
        override func layoutUI() {
            ...
            switCh.snp.makeConstraints { (make) in
                make.centerY.equalToSuperview()
                make.right.equalTo(-24.auto())
                make.size.equalTo(CGSize(width: 51, height: 31).auto())
            }
        ...
        override class func height(model: Any?) -> CGFloat {
            if let rs = model as? String {
                ...
                let font2:UIFont = UILabel().then {
                                       ...
                                       rs.lineSpacingLabel($0)
                                       $0.autoFont = true }.font
                let height = rs.height(ofWidth: width, attributes: [.font: font2,
                                                                    .paragraphStyle: style])
                return (8 + 24 + 22 + 10).auto() + height + (24 + 8).auto()
            }
            return 88.auto()
        }
        ...
        override func update(model: Any?) {
            if let rs = model as? String {
                rs.lineSpacingLabel(subTitleLabel)
            }
        }
    }
        ...
        lazy var subTitleLabel: UILabel = {
                ...
                override class func height(model: Any?) -> CGFloat {
                    if let rs = model as? String {
                        ...
                        let height = rs.height(ofWidth: width, attributes: [.font: font2,
                                                                            .paragraphStyle: style])
                        return (8 + 24 + 22 + 10).auto() + height + (24).auto()
                    }
                    return 88.auto()
                }

...
extension ChangeNodeAlertController {
    class ContentCell: FxTableViewCell {
        ...
        lazy var noticeLabel1: UILabel = {
            let v = UILabel(text: TR("ChangeNode.Alert.Notice1$", ""), font: XWallet.Font(ofSize: 20, weight: .medium))
        ...
        private lazy var noticeLabel2: UILabel = {
            let v = UILabel(text: TR("ChangeNode.Alert.Notice2"), font: XWallet.Font(ofSize: 14), textColor: UIColor.white.withAlphaComponent(0.5))
            v.textAlignment = .center
            v.autoFont = true
            v.numberOfLines = 0
            return v
        ...
        override class func height(model: Any?) -> CGFloat {
            ...
            let font1:UIFont = UILabel().then {
                ...
                $0.text = TR("ChangeNode.Alert.Notice1")
                $0.autoFont = true }.font
            
            let font2:UIFont = UILabel().then {
                $0.font = XWallet.Font(ofSize: 14)
                $0.text = TR("ChangeNode.Alert.Notice2")
                $0.autoFont = true }.font
            
            let noticeHeight1 = TR("ChangeNode.Alert.Notice1").height(ofWidth: width, attributes: [.font: font1])
            let noticeHeight2 = TR("ChangeNode.Alert.Notice2").height(ofWidth: width, attributes: [.font: font2])
...
extension ChangeNodeAlertController {
    ...
    class ActionCell: WKTableViewCell.DoubleActionCell {
        ...
        override func configuration() {
            ...
            confirmButton.title = TR("Confirm")

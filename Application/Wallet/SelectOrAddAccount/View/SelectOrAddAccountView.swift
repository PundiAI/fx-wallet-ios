...
extension SelectOrAddAccountViewController {
    class View: UIView {
        ...
        lazy var switchToMyAssets: UIButton = {
            ...
            v.setAttributedTitle(NSAttributedString(string: TR("SelectOrAddAccount.MyAssets"), attributes: [.font: XWallet.Font(ofSize: 16), .foregroundColor: HDA(0x080A32)]), for: .normal)
            v.setAttributedTitle(NSAttributedString(string: TR("SelectOrAddAccount.MyAssets"), attributes: [.font: XWallet.Font(ofSize: 16, weight: .medium), .foregroundColor: HDA(0x080A32)]), for: .selected)
            return v
        }()
        ...
        lazy var switchToAll: UIButton = {
            let v = UIButton(.clear)
            v.titleColor = HDA(0x080A32)
            v.setAttributedTitle(NSAttributedString(string: TR("SelectOrAddAccount.AllAvailable"), attributes: [.font: XWallet.Font(ofSize: 16), .foregroundColor: HDA(0x080A32)]), for: .normal)
            v.setAttributedTitle(NSAttributedString(string: TR("SelectOrAddAccount.AllAvailable"), attributes: [.font: XWallet.Font(ofSize: 16, weight: .medium), .foregroundColor: HDA(0x080A32)]), for: .selected)
            return v
        }()

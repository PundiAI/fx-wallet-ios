...
import UIKit
import WKKit
private let radius: CGFloat = 49
private let diameter: CGFloat = 49 * 2
private let viewSize: CGFloat = 195
class WalletHaloAnimationView: UIView {
    ...
    fileprivate func layoutUI() {
        ...
        let coverLayer = circle(bounds: bounds, position: center, fillColor: UIColor.black)
...
class WalletLaunchHaloAnimationView: WalletHaloAnimationView {
    ...
    override fileprivate func circle(bounds: CGRect, position: CGPoint, fillColor: UIColor) -> CAShapeLayer {

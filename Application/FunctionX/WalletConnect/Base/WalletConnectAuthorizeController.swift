//
//  WalletConnectAuthorizeController.swift
//  XWallet
//
...
class WalletConnectAuthorizeController: WKViewController {
    ...
    func dismiss(userCanceled: Bool = false, animated: Bool = true, completion: (() -> Void)? = nil) {
    ...
    class DappInfoCell: FxTableViewCell {
        ...
        override func layoutUI() {
            ...
            if viewModel.authorizeTypes.count > 0 {
                ...
                if viewModel.authorizeTypes.count == 1 {
                    
                    let t = viewModel.authorizeTypes.first!
                    let height = t.height
...
extension WalletConnectAuthorizeController {
    ...
    class AuthorizeCell: UIView {
        ...
        func bind(_ viewModel: Any?) {
            ...
            self.titleLabel.text = type.info.text
        }
...
extension WalletConnectAuthorizeController : HeroViewControllerDelegate {
    ...
    private func bindHero() {
        ...
        animators["0"] = WKHeroAnimator({ (_) in
            welf?.view.hero.modifiers = [.useGlobalCoordinateSpace,

...
extension EditAddressNameAlertController {
    override class func instance(with context: [String: Any] = [:]) -> UIViewController? {
        ...
        if let completionHandler = context["handler"] as? (String) -> Void {
...
class EditAddressNameAlertController: WKPopViewController {
    ...
    private func bindUI() {
        viewS.inputTF.text = UserDefaults.standard.remark(ofAddress: address)
        viewS.addressLabel.text = address

//
//  FxCloudSubmitValidatorAddressViewController.swift
//  XWallet
//
...
class FxCloudSubmitValidatorAddressViewController: FxCloudWidgetActionViewController {
    ...
    override func bindList() {
        ...
        self.selectCell = listBinder.push(SelectValidatorAddressCell.self)
    ...
    override func bindAction() {
        ...
        wk.view.confirmButton.rx.tap.subscribe(onNext: { [weak self] (_) in
            ...
            //submit and result is two step in one controller, so, router is unnecessary
    ...
    private var validatorAddress: String {
        guard let keypair = self.selectKeypair.value else { return "" }
...
//MARK: FxCloudSubmitValidatorAddressCompletedViewController

...
extension FxCloudCreateValidatorViewController {
    func addShadow() {
        ...
        view.layer.insertSublayer(v, below: wk.view.confirmButton.layer)
    }
}
...
extension FxCloudCreateValidatorViewController {
    class HeaderCell: WKTableViewCell {
        lazy var contentLabel: UILabel = {
            ...
            attText.addAttributes([.foregroundColor: v.backgroundColor!], range: NSRange(location: text.count - 1, length: 1))
